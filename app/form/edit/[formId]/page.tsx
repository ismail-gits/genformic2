...
export default function EditForm() {
  ...
  return (
    <div className="p-6">
      <h2 className="flex items-center gap-2 my-5 hover:font-bold hover:text-lg transition">
      ...
      <div className="grid grid-col-1 md:grid-cols-3 gap-5">
        ...
        <div className="md:col-span-2 border rounded-lg p-5 h-screen flex items-center justify-center"><FormUi form={form}/></div>
      </div>
    </div>
  );
}
