      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
          <div className="rounded-2xl border border-indigo-600 p-6 shadow-xs ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12">
            ...
            <a
              href={`https://buy.stripe.com/test_7sYcN5bhCbiV0bw5FEds402?prefilled_email=${user.user?.primaryEmailAddress}`}
              target="_blank"
          ...
          <div className="rounded-2xl border border-gray-200 p-6 shadow-xs sm:px-8 lg:p-12">
            ...
            <a
              href={`https://buy.stripe.com/test_28E5kD85qaeR7DY8RQds401?prefilled_email=${user.user?.primaryEmailAddress}`}
              target="_blank"
